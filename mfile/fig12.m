...
% ------------------------------------
% ---------- NOTE 1:
% the following codes is for part (d) of figure 12, for other parts just
% the variable "BR_2V_1V" in line 71 should be changed as follows:
...
%%%%&&&
   ...
   x_1_V=dt*((landa_1_V-y_1_V.^2)*x_1_V-p_1_V.^2*y_1_V+...
       B_1_V*x_S+BR_2V_1V*(y_2_V-y_1_V))+...
       x_1_V;
   ...
   x_2_V=dt*((landa_2_V-y_2_V.^2)*x_2_V-p_2_V.^2*y_2_V+...
       B_2_V*x_S+BR_2V_1V*(y_1_V-y_2_V))+...         
       x_2_V;
