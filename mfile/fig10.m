%%% codes for producing fig.10 in the following manuscript
...
for landa = [0.1 0.2 0.3 0.4]

    landa_1_V = landa;  % landa value in vanderpol eq. that reperesents visual 1
    ...
    landa_2_V  = landa;  % landa value in vanderpol eq. that reperesents visual 2
